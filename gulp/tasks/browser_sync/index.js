...
gulp.task('browser-sync', function() {
  ...
  gulp.watch('dist/assets/styles/style.css').on('change', browserSync.reload);

  gulp.watch('./src/assets/scripts/**/*.js', gulp.series('babel'));
  gulp.watch('dist/assets/scripts/babel.js').on('change', browserSync.reload);
